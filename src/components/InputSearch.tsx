...
const InputSearch: React.FC<InputSearchProps> = ({ value, setValue, width }) => {

    return (
        <div className={`${width || "w-56"}  h-9 px-3 border border-border rounded-full flex flex-row items-center`}>
